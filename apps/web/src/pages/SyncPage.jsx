      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm text-center">
        ...
        <div className="mb-8 text-left">
          <label className="block text-sm font-medium text-gray-700 mb-1">
            LEETCODE_SESSION Cookie (Optional if set in .env)
          </label>
          <input
            type="password"
          ...
          <p className="text-xs text-gray-400 mt-2">
            To find this: Go to leetcode.com &gt; F12 (Developer Tools) &gt; Application tab &gt; Cookies &gt; copy the value of LEETCODE_SESSION.
          </p>
        </div>
        ...
        {mutation.isError && (
          <div className="mt-6 p-4 bg-red-50 text-red-600 rounded-xl text-sm break-words">
