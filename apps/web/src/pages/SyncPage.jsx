...
function SyncPage() {
  ...
  return <div className="p-8 max-w-2xl mx-auto mt-10">
  ...
  >
        ...
        {mutation.isError && <div className="mt-6 p-4 bg-red-50 text-red-600 rounded-xl text-sm">
            {mutation.error.message}
          </div>}

        {mutation.isSuccess && lastSync && <div className="mt-6 p-4 bg-green-50 text-green-700 rounded-xl flex items-center justify-center gap-3">
